    ...
    <>
      ...
      <div className="p-10 lg:p-32 container max-w-7xl mx-auto">
        ...
        <div className="font-archivo text-lg lg:text-xl">
          <p>
            The Quality: Environmental and Health & Safety Policy for Marcol Fabrications (Plastics) Limited has now been realigned to reflect the changes within the new Standards released. The Policy is set out to reflect how these changes influence the business context and its strategic direction as well as embracing the requirements of both internal and external parties.          </p>
          <br />
          <p>
            It is incumbent on Marcol Fabrications (Plastics) Limited to identify all interested parties that influences the business and its context. Marcol Fabrications (Plastics) Limited has set out to recognise and determine levels of Risk that could impact the business such as poor quality of service; failure to prevent the effects of pollution and protection of the environment. Failure to protect all interested parties from harm through poor health & safety all of which could have a major impact on both its customer portfolio and own business strategic direction.          </p>
          <br />
          <p>
            Having identified the Risks to the business Marcol Fabrications (Plastics) Limited has set out to plan and implement actions to address those Risks by either reducing or eliminating those Risks!          </p>
          <br />
          <p>
            Business Objectives are set to encompass and address perceived issues that could adversely influence the business and to fully support the achievement of this Policy as well as the Business Management System and to provide a platform for continual improvement.          </p>
          <br />
          <p>
            Marcol Fabrications (Plastics) Limited continue to identify all its compliance obligations and strives to ensure compliance in all respects.          </p>
          <br />
          <p>
            In addition, the Business has established a full CSR (Corporate Social Responsibility and Sustainability Policy) that emphasises its commitment to its employees (internal interested parties) as well as its external interested parties.          </p>
          <br />
          <p>
            The business has established an active Internal Audit Program to monitor, measure and review the delivery and effectiveness of these plans.          </p>
          <br />
          <p>
            The above Policy will be maintained as a documented reference and reviewed at least annually as well as being made available to all interested parties as appropriate and communicated, understood and applied within the organisation itself.          </p>
        </div>
